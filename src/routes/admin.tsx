...
import {
  LayoutDashboard, Users, BookOpen, CheckSquare, Database,
  BarChart3, ScrollText, Megaphone, FileBarChart, UserCircle, Network, LineChart,
} from "lucide-react";
...
export const Route = createFileRoute("/admin")({
  head: () => ({ meta: [{ title: "Admin · AI Tutor" }, { name: "description", content: "Admin portal for AI Tutor." }] }),
