    ...
    <div>
      ...
      <div className="mb-6 grid grid-cols-2 gap-3 md:grid-cols-4">
        {[
          ...
          <div
            key={label}
            className="rounded-2xl bg-card p-4 shadow-[0_1px_2px_rgba(0,0,0,0.04),0_8px_24px_-12px_rgba(30,27,60,0.08)]"
          >
                  ...
                  <tr key={d.id} className="border-t border-border hover:bg-accent/40">
                      ...
                      <div className="flex items-center gap-2.5">
                        <span
                          className={cn(
                            ...
                            FILE_COLORS[d.fileType],
                          )}
                        >
                          <Icon className="h-4 w-4" />
                        </span>
                        <div>
                          <div className="font-medium text-foreground leading-tight max-w-[180px] truncate">
                            {d.name}
                          </div>
                    ...
                    <td className="py-3 pr-4 max-w-[140px]">
                      <span className="block truncate text-xs text-muted-foreground">
                        {mod?.name ?? <span className="italic text-muted-foreground">—</span>}
                      </span>
                    </td>
                    <td className="py-3 pr-4">
                      {d.topicTag ? (
                    ...
                    <td className="py-3 pr-4 space-y-1">
                      ...
                      {d.status === "approved" &&
                      (d.ingestionStatus === "failed" || d.chunks === 0) ? (
